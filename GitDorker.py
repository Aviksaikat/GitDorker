...
# Read token from enviroment
try:
    load_dotenv()
    tokens_list = os.environ.get("GIT_DORKER_TOKEN")
    #print(tokens_list)
except:
    pass
...
if not len(tokens_list):
    parser.error("auth token is missing please add it to the environment or supply through cli")
